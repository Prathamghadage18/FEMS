...
const CropMarket = () => {
  return (
    <div className='w-full'>
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Crop Market Trends</h1>

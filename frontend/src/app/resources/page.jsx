...
const SAMPLE_RESOURCES = [
  {
    ...
    description:
      "Learn how crop rotation can improve soil health and increase yields. This comprehensive guide covers different rotation patterns for various crops.",
    resource_type: "GUIDE",
  ...
  },
  {
    ...
    description:
      "Discover sustainable pest management techniques that reduce chemical usage while protecting your crops.",
  ...
  },
  {
    ...
    description:
      "Step-by-step video guide on setting up efficient drip irrigation systems for maximum water conservation.",
    resource_type: "VIDEO",
    category: "IRRIGATION",
    is_featured: false,
    views_count: 2341,
  ...
  },
  {
    ...
    description:
      "Understanding soil composition and how to test your soil for optimal crop growth.",
    resource_type: "PDF",
  ...
  },
  {
    ...
    description:
      "How to read weather patterns and use forecasting apps to plan farming activities.",
    resource_type: "ARTICLE",
    category: "WEATHER",
    is_featured: false,
    views_count: 789,
  ...
  },
  {
    ...
    description:
      "Analysis of crop market prices and predictions for the coming season.",
...
const ResourceCard = ({ resource }) => {
  const typeInfo =
    RESOURCE_TYPES.find((t) => t.value === resource.resource_type) ||
    RESOURCE_TYPES[5];
  const categoryInfo =
    CATEGORIES.find((c) => c.value === resource.category) || CATEGORIES[9];

  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-md hover:shadow-lg transition-all overflow-hidden">
      {/* Thumbnail/Header */}
      <div
        className={`p-4 bg-gradient-to-r from-green-50 to-green-100 border-b border-gray-100`}
      >
...
const ResourceLibrary = () => {
  ...
  const fetchResources = async () => {
    ...
    try {
      ...
      setResources(
        fetchedResources.length > 0 ? fetchedResources : SAMPLE_RESOURCES,
      );
    } catch (err) {
    ...
    <main className="form-container">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Access articles, guides, and resources to enhance your farming
          knowledge
        </p>
      </div>

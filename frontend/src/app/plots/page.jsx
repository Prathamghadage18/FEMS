            ...
            {plots.map((plot) => (
              ...
              >
                ...
                <p className="text-gray-600 mt-1">
                  Area: <span className="font-semibold">{plot.area} acres</span>
                </p>
                {plot.soil_type && (
                  <p className="text-gray-600">
                    Soil:{" "}
                    <span className="font-semibold">{plot.soil_type}</span>
                  </p>
                )}
                {plot.village && (
                  <p className="text-gray-600">
                    Village:{" "}
                    <span className="font-semibold">{plot.village}</span>
                  </p>
                )}
              </div>
            ))}

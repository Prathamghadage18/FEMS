    ...
    <div className="bg-gradient-to-br from-green-100 to-green-200 min-h-screen flex flex-row">
      ...
      <div className="lg:w-1/2 w-full py-4 px-2">
        ...
        <div className="bg-white p-6 rounded-2xl md:w-4/5 mb-4 md:mx-auto mx-2 shadow-xl">
          ...
          <h1 className="text-2xl md:text-3xl mb-6 text-center font-bold text-gray-800">
            Create an Account
          </h1>
              ...
              <div className="flex items-center gap-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    name="userType"
                    value="FARMERS"
                    checked={userType === "FARMERS"}
                    onChange={() => setUserType("FARMERS")}
                    required
          ...
          <div className="flex justify-center gap-3 md:gap-4">
            <button
              type="button"
              className="bg-green-500 text-white p-3 text-lg rounded-full hover:bg-green-600 transition-colors shadow-md"
            >
              <BsGoogle />
            </button>
            <button
              type="button"
              className="bg-blue-600 text-white p-3 text-lg rounded-full hover:bg-blue-700 transition-colors shadow-md"
            >
              <BsFacebook />
            </button>
            <button
              type="button"
              className="bg-pink-600 text-white p-3 text-lg rounded-full hover:bg-pink-700 transition-colors shadow-md"
            >
              <BsInstagram />
            </button>
            <button
              type="button"
              className="bg-blue-500 text-white p-3 text-lg rounded-full hover:bg-blue-600 transition-colors shadow-md"
            >
              <BsTelegram />
            </button>
            <button
              type="button"
              className="bg-gray-800 text-white p-3 text-lg rounded-full hover:bg-gray-900 transition-colors shadow-md"
            >
              <BsTwitterX />
            </button>
          </div>

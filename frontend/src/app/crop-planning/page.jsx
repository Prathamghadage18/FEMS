    ...
    <main className="form-container">
      ...
      <div className="form-grid">
        ...
        <RadioInput
          ...
          name="mixed-cropping"
          onSelect={(e) =>
            handleRadioChange("is_mixed_cropping", e.target.value)
          }
          options={["Yes", "No"]}
        />
        <RadioInput
        ...
        <RadioInput
          ...
          onSelect={(e) =>
            handleRadioChange("fertilizer_required", e.target.value)
          }
          options={["Yes", "No"]}
        />
        <RadioInput
          ...
          onSelect={(e) =>
            handleRadioChange("manpower_required", e.target.value)
          }
          options={["Yes", "No"]}
        />
      </div>
            ...
            {cropPlans.map((plan) => (
              ...
              >
                ...
                <p className="text-gray-600 mt-1">
                  Plot: <span className="font-semibold">{plan.plot_name}</span>
                </p>
                {plan.planting_date && (
                  <p className="text-gray-600">
                    Planted:{" "}
                    <span className="font-semibold">{plan.planting_date}</span>
                  </p>
                )}

...
export const waterResourcesAPI = {
  ...
  getAll: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/plot/water-resources/${queryString ? "?" + queryString : ""}`,
    );
  },
...
export const cropPlanningAPI = {
  ...
  getAll: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/crop/crop-plots/${queryString ? "?" + queryString : ""}`,
    );
  },
...
export const machineryAPI = {
  ...
  getAll: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/crop/machinery/${queryString ? "?" + queryString : ""}`,
    );
  },
...
export const fertilizersAPI = {
  ...
  getAll: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/crop/fertilizers/${queryString ? "?" + queryString : ""}`,
    );
  },
...
export const wholesalerAPI = {
  ...
  getAll: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/wholeseller/wholesalers/${queryString ? "?" + queryString : ""}`,
    );
  },
  ...
  getTransactions: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/wholeseller/transactions/${queryString ? "?" + queryString : ""}`,
    );
  },
  ...
  getCrops: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/wholeseller/wholesaler-crops/${queryString ? "?" + queryString : ""}`,
    );
  },
  ...
  getSupplyRequests: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/wholeseller/supply-requests/${queryString ? "?" + queryString : ""}`,
    );
  },
...
export const resourcesAPI = {
  ...
  getAll: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/crop/resources/${queryString ? "?" + queryString : ""}`,
    );
  },
...
export const marketPricesAPI = {
  ...
  getAll: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    return apiRequest(
      `/crop/market-prices/${queryString ? "?" + queryString : ""}`,
    );
  },
